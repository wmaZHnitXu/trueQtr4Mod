...
public class TurretCollisionCapBlock extends uebokblock {
    /*
     *   0  1  2
     *   3  4  5
     *   6  7  8
    ...
    public TurretCollisionCapBlock() {
        super("turretcollisioncap", Material.IRON, 3, 1, SoundType.METAL);
    ...
    private AxisAlignedBB getBoxFromLocation (int location) {
        ...
        switch (location) {
            ...
            case 2:
                return new AxisAlignedBB(0.5d, 0, 0d, 1d, 0.7d, 0.5d);
            case 5://
                return new AxisAlignedBB(0d, 0d, 0d, 1d, 0.7d, 0.5d);
            case 8:
                return new AxisAlignedBB(0d, 0d, 0d, 0.5d, 0.7d, 0.5d);
            case 1://
                return new AxisAlignedBB(0.5d, 0d, 0d, 1d, 0.7d, 1d);
            case 4:
                return new AxisAlignedBB(0d, 0d, 0d, 1d, 0.7d, 1d);
            case 7://
                return new AxisAlignedBB(0d, 0d, 0d, 0.5d, 0.7d, 1d);
            case 0:
                return new AxisAlignedBB(0.5d, 0d, 0.5d, 1d, 0.7d, 1d);
            case 3://
                return new AxisAlignedBB(0, 0d, 0.5d, 1d, 0.7d, 1d);
            case 6:
                return new AxisAlignedBB(0, 0d, 0.5d, 0.5d, 0.7d, 1d);
        }

        return new AxisAlignedBB(0,0,0,1,0.7d,1);
